...
DXRTriangleInstanceApp::DXRTriangleInstanceApp(UINT width, UINT height, std::wstring name)
...
void DXRTriangleInstanceApp::Render()
{
	WriteCommand();
...
void DXRTriangleInstanceApp::Flip()
{
...
void DXRTriangleInstanceApp::Finalize()
{
}

void DXRTriangleInstanceApp::LoadPipeline()
{
	UINT flags = 0;
#ifdef _DEBUG
...
void DXRTriangleInstanceApp::CreateDXRDeviceAndSwapChain(HWND hwnd, D3D_FEATURE_LEVEL feature)
{
...
void DXRTriangleInstanceApp::CreateCommandObject()
{
...
void DXRTriangleInstanceApp::CreateSyncObject()
{
...
void DXRTriangleInstanceApp::CreateRTVHeapAndRTV()
{
...
void DXRTriangleInstanceApp::LoadAssets()
{
...
void DXRTriangleInstanceApp::WriteCommand() const
{
...
void DXRTriangleInstanceApp::GPUSync()
{
...
void DXRTriangleInstanceApp::CheckDXRSupport() const
{
...
void DXRTriangleInstanceApp::CreateCameraBuffer()
{
...
void DXRTriangleInstanceApp::UpdateCameraBuffer() const
{
...
void DXRTriangleInstanceApp::CreatePlaneVB()
{
...
void DXRTriangleInstanceApp::CreatePerInstanceConstantBuffers()
{
...
DXRTriangleInstanceApp::AccelerationStructureBuffers 
DXRTriangleInstanceApp::CreateBottomLevelAS(std::vector<std::pair<ComPtr<ID3D12Resource>, uint32_t>> vVertexBuffers) const
{
...
void DXRTriangleInstanceApp::CreateTopLevelAS(const std::vector<std::pair<ComPtr<ID3D12Resource>, Matrix>>& instances)
{
	ComPtr<ID3D12Device5> device5;
	FAILED_CHECK_BREAK(_device->QueryInterface(IID_PPV_ARGS(device5.GetAddressOf())));
...
void DXRTriangleInstanceApp::CreateAccelerationStructures()
{
...
ComPtr<ID3D12RootSignature> DXRTriangleInstanceApp::CreateRayGenSignature() const
{
...
ComPtr<ID3D12RootSignature> DXRTriangleInstanceApp::CreateMissSignature() const
{
	nv_helpers_dx12::RootSignatureGenerator rsc;
	return rsc.Generate(_device.Get(), true);
}

ComPtr<ID3D12RootSignature> DXRTriangleInstanceApp::CreateHitSignature() const
{
	nv_helpers_dx12::RootSignatureGenerator rsc;
...
void DXRTriangleInstanceApp::CreateRaytracingPipeline()
{
	ComPtr<ID3D12Device5> device5;
	FAILED_CHECK_BREAK(_device->QueryInterface(IID_PPV_ARGS(device5.GetAddressOf())));
...
void DXRTriangleInstanceApp::CreateRayTracingOutputBuffer()
{
...
void DXRTriangleInstanceApp::CreateShaderResourceHeap()
{
	D3D12_DESCRIPTOR_HEAP_DESC heapDesc{};
...
void DXRTriangleInstanceApp::CreateShaderBindingTable()
{
	_sbtHelper.Reset();
	...
	_sbtHelper.AddHitGroup(L"PlaneHitGroup", {});
