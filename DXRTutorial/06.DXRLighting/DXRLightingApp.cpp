...
std::vector<ComPtr<ID3D12Resource>> DXRLightingApp::gUploadBuffers{};

DXRLightingApp::DXRLightingApp(UINT width, UINT height, std::wstring name)
...
void DXRLightingApp::Initialize()
{
	LoadPipeline();
...
void DXRLightingApp::Update(const float& dt)
{
}

void DXRLightingApp::Render()
{
	_commandAlloc->Reset();
	_commandList->Reset(_commandAlloc.Get(), nullptr);
	BeginFrame();
...
void DXRLightingApp::CheckDebug()
{
	_commandList->Close();
...
void DXRLightingApp::Finalize()
{
}

uint32_t DXRLightingApp::BeginFrame()
{
...
void DXRLightingApp::LoadPipeline()
{
#ifdef _DEBUG
...
void DXRLightingApp::CreateDXRDeviceAndSwapChain(HWND hwnd, D3D_FEATURE_LEVEL feature)
{
...
void DXRLightingApp::CreateCommandObject()
{
...
void DXRLightingApp::CreateSyncObject()
{
...
void DXRLightingApp::CreateRTVHeapAndRTV()
{
...
void DXRLightingApp::CheckDXRSupport() const
{
...
void DXRLightingApp::CreateAccelerationStructures()
{
...
void DXRLightingApp::CreateRTPipelineState()
{
	// 12 object
	// 1 dxil library
	// 1 hit group
	...
	const WCHAR* shaderExports[] = {
		RTPipeline::MissShader,RTPipeline::ClosestHitShader,RTPipeline::RayGenShader
	};
...
void DXRLightingApp::CreateShaderResource()
{
	...
	AccelerationStructure::ShapeResource* primitives = _resources[0].get();
