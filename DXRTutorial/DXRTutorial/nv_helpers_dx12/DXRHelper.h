...
namespace nv_helpers_dx12
{
	                                    ...
	                                    const D3D12_HEAP_PROPERTIES& heapProps)
	{
		...
		FAILED_CHECK_BREAK(m_device->CreateCommittedResource(&heapProps, D3D12_HEAP_FLAG_NONE, &bufDesc,
	                                                  ...
	                                                  const D3D12_DESCRIPTOR_HEAP_TYPE type, const bool shaderVisible)
	{
		...
		FAILED_CHECK_BREAK(device->CreateDescriptorHeap(&desc, IID_PPV_ARGS(&pHeap)));
		return pHeap;
	}
