...
class DXRTriangleInstanceAnimationApp : public DXRSample
{
public:
	DXRTriangleInstanceAnimationApp(UINT width, UINT height, std::wstring name);
...
private:
	...
	*/
	...
	ComPtr<IDxcBlob> _shadowLibrary;
	...
	ComPtr<ID3D12RootSignature> _shadowSignature;
