...
std::vector<ComPtr<ID3D12Resource>> DXRReflectionApp::gUploadBuffers{};

DXRReflectionApp::DXRReflectionApp(UINT width, UINT height, std::wstring name)
...
void DXRReflectionApp::Initialize()
{
	LoadPipeline();
...
void DXRReflectionApp::Update(const float& dt)
{
}

void DXRReflectionApp::Render()
{
	_commandAlloc->Reset();
	_commandList->Reset(_commandAlloc.Get(), nullptr);
	BeginFrame();
...
void DXRReflectionApp::CheckDebug()
{
	_commandList->Close();
...
void DXRReflectionApp::Finalize()
{
}

uint32_t DXRReflectionApp::BeginFrame()
{
...
void DXRReflectionApp::EndFrame()
{
	auto br = CD3DX12_RESOURCE_BARRIER::Transition(
...
void DXRReflectionApp::LoadPipeline()
{
#ifdef _DEBUG
...
void DXRReflectionApp::CreateDXRDeviceAndSwapChain(HWND hwnd, D3D_FEATURE_LEVEL feature)
{
...
void DXRReflectionApp::CreateCommandObject()
{
...
void DXRReflectionApp::CreateSyncObject()
{
...
void DXRReflectionApp::CreateRTVHeapAndRTV()
{
...
void DXRReflectionApp::CheckDXRSupport() const
{
...
void DXRReflectionApp::CreateAccelerationStructures()
{
...
void DXRReflectionApp::CreateRTPipelineState()
{
	// 12 object
	// 1 dxil library
	// 1 hit group
...
void DXRReflectionApp::CreateShaderTable()
{
	/*
...
void DXRReflectionApp::CreateShaderResource()
{
