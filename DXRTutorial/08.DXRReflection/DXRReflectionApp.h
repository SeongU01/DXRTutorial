...
class DXRReflectionApp : public DXRSample
{
public:
	DXRReflectionApp(UINT width, UINT height, std::wstring name);
...
private:
	...
	std::vector<AccelerationStructureBuffers> _pBottomLevelAS;
